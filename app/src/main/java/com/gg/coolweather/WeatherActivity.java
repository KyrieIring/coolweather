...
import com.gg.coolweather.gson.Forecast;
import com.gg.coolweather.gson.Weather;
import com.gg.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    private void loadBingPic() {
        ...
        HttpUtil.sendOkHttpRequest(bingPicUrl, new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                edit.putString("bing_pic",responseText).apply();
    ...
    public void requestWeather(String weather_id) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid="+weather_id+"&key=240bbe50d7be4845abfb29bd7fd40dda";
